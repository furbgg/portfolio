...
export default function MDetails() {
    ...
    <section id="slide-1" className="slide bg-cover bg-center" style={{backgroundImage: 'linear-gradient(rgba(15, 23, 42, 0.85), rgba(15, 23, 42, 0.95)), url("https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&q=80")'}}>
        <div className="max-w-6xl mx-auto w-full fade-in relative z-10 text-center lg:text-left">
            ...
            <a href="#slide-2" className="inline-flex items-center gap-2 bg-m-brand-gold hover:bg-m-brand-goldlight text-m-brand-900 font-bold py-4 px-8 rounded-full transition-all mt-4">
                Shopify vs. Individuelle Infrastruktur <span className="material-symbols-outlined">arrow_downward</span>
            </a>
        </div>
    </section>
    ...
    <section id="slide-2" className="slide">
        <div className="max-w-6xl mx-auto w-full">
            <div className="text-center mb-16 fade-in">
                <h2 className="font-serif text-4xl md:text-6xl gold-gradient-text mb-4">Die Illusion des Fertig-Systems</h2>
                <p className="text-slate-400 text-lg">Plattformen scheinen anfangs günstig, aber die versteckten Kosten für österreichische Einzelhändler sind enorm.</p>
            </div>

            <div className="grid md:grid-cols-3 gap-8">
                <div className="glass-card p-8 rounded-3xl fade-in delay-1">
                    <span className="material-symbols-outlined text-red-400 text-4xl mb-4">money_off</span>
                    <h3 className="text-xl font-bold mb-3 text-white">Provisionen und 'App'-Mieten</h3>
                    <p className="text-slate-400 text-sm leading-relaxed">Mit Mehrsprachigkeit, USt.-Rechnungen, rechtlichen Versandprozessen und Varianten-Erweiterungen übersteigen die obligatorischen <strong>App-Mieten 100€ im Monat.</strong> Zudem fällt bei jedem Verkauf eine Provision an.</p>
                </div>
                
                <div className="glass-card p-8 rounded-3xl fade-in delay-1">
                    <span className="material-symbols-outlined text-orange-400 text-4xl mb-4">speed</span>
                    <h3 className="text-xl font-bold mb-3 text-white">Geladene Plugins = Geschwindigkeits- und SEO-Einbruch</h3>
                    <p className="text-slate-400 text-sm leading-relaxed">Jede App, die Sie auf Shopify installieren, bedeutet unnötigen Code. Ihre Seite lädt zu langsam, Sie fallen bei lokalen SEO-Suchen hinter die Konkurrenz zurück.</p>
                </div>
                
                <div className="glass-card p-8 rounded-3xl fade-in delay-2">
                    <span className="material-symbols-outlined text-yellow-500 text-4xl mb-4">gavel</span>
                    <h3 className="text-xl font-bold mb-3 text-white">Abmahnungsrisiko in der DACH-Region</h3>
                    <p className="text-slate-400 text-sm leading-relaxed">Die DSGVO-Regeln sind in Österreich sehr streng. Shopify unterstützt diese nicht standardmäßig. Ein inkompatibler Checkout kann zu Abmahnungen von Tausenden Euro führen.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="slide-3" className="slide bg-m-brand-800 relative z-10 overflow-hidden">
        <div className="max-w-6xl mx-auto w-full fade-in h-full flex flex-col justify-center">
            <h2 className="font-serif text-4xl md:text-5xl mb-4 text-white text-center">Warum es für Möbel <span className="text-red-400">nicht passt?</span></h2>
            <p className="text-slate-300 text-lg mb-12 text-center max-w-2xl mx-auto">Die Infrastruktur für den Verkauf von T-Shirts und einem multifunktionalen L-Sofa für 1500€ kann nicht identisch sein.</p>
            
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                {/*  THE SHOPIFY LIMITATION ANIMATION  */}
                <div className="glass-card p-6 md:p-8 rounded-[2rem] border-red-500/30 bg-slate-900/80 warning-pulse relative h-[450px] flex flex-col justify-between">
                    <div className="absolute top-0 right-0 bg-red-600 text-white px-4 py-1 rounded-bl-xl rounded-tr-[2rem] text-xs font-bold tracking-widest">TRADITIONELL (SHOPIFY)</div>
                    <div>
                        <h4 className="text-2xl font-bold text-red-400 mb-6 flex items-center gap-2"><span className="material-symbols-outlined border border-red-400 rounded-full p-1">close</span> Das Varianten-Limit-Konzept</h4>
                        <p className="text-slate-400 text-sm mb-6">Traditionelle Systeme haben ein Limit von maximal 3 Optionen (z. B. Farbe, Größe) und <strong className="text-white">100 Varianten</strong>.</p>
                        
                        {/*  Animated Box showing the limit hit  */}
                        <div className="bg-black/40 rounded-xl p-4 border border-slate-700 h-[180px] overflow-hidden relative">
                            <div className="text-xs text-slate-500 mb-2 font-mono border-b border-slate-700 pb-2">Produkteditor &gt; Varianten</div>
                            
                            <div className="space-y-4 pt-2">
                                <div className="flex justify-between text-xs items-center bg-slate-800 p-2 rounded">
                                    <span className="text-slate-300">Option 1: Stofffarbe</span>
                                    <span className="text-emerald-400">Hinzugefügt (12 Farben)</span>
                                </div>
                                <div className="flex justify-between text-xs items-center bg-slate-800 p-2 rounded">
                                    <span className="text-slate-300">Option 2: Fußart (Holz/Metall)</span>
                                    <span className="text-emerald-400">Hinzugefügt (4 Typen)</span>
                                </div>
                                <div className="flex justify-between text-xs items-center bg-slate-800 p-2 rounded">
                                    <span className="text-slate-300">Option 3: Ausrichtung (Rechts/Links)</span>
                                    <span className="text-emerald-400">Hinzugefügt (2 Richtungen)</span>
                                </div>
                ...
                {/*  OUR SOLUTION ANIMATION  */}
                <div className="glass-card p-6 md:p-8 rounded-[2rem] border-m-brand-gold/50 bg-slate-900/80 success-pulse relative h-[450px] flex flex-col justify-between">
                    <div className="absolute top-0 right-0 bg-m-brand-gold text-m-brand-900 px-4 py-1 rounded-bl-xl rounded-tr-[2rem] text-xs font-bold tracking-widest pl-6">UNSERE ARCHITEKTUR</div>
                    <div>
                        <h4 className="text-2xl font-bold text-m-brand-gold mb-6 flex items-center gap-2"><span className="material-symbols-outlined border border-m-brand-gold rounded-full p-1">done_all</span> Unbegrenzte Kombinationsfreiheit</h4>
                        <p className="text-slate-400 text-sm mb-6">Unsere Architektur ist auf die Dynamik von Möbeln ausgelegt. Sie verwalten sofort <strong className="text-white">unbegrenzte (1000+) Variantenkonfigurationen</strong> für jedes L-Sofa.</p>
                        
                        {/*  Animated UI showing unlimited scrolling/building  */}
                        <div className="bg-black/40 rounded-xl p-4 border border-slate-700 h-[180px] overflow-hidden relative">
                            <div className="text-[10px] font-bold text-m-brand-gold mb-3 uppercase flex items-center gap-2">
                                <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span> Kundenkonfigurator
                            </div>
                            ...
                            <div className="h-[120px] overflow-hidden relative">
                                ...
                                <div className="animate-slide-up-loop space-y-3">
                                    <div className="bg-slate-800 border border-slate-700 rounded-lg p-2 px-3 text-xs flex justify-between">
                                        <span className="text-white">1. Stoffauswahl</span><span className="text-m-brand-gold">Samtblau</span>
                                    </div>
                                    <div className="bg-slate-800 border border-slate-700 rounded-lg p-2 px-3 text-xs flex justify-between">
                                        <span className="text-white">2. Ausrichtung</span><span className="text-m-brand-gold">Rechte Ecke</span>
                                    </div>
                                    <div className="bg-slate-800 border border-slate-700 rounded-lg p-2 px-3 text-xs flex justify-between">
                                        <span className="text-white">3. Fußoberfläche</span><span className="text-m-brand-gold">Mattes Walnuss</span>
                                    </div>
                                    <div className="bg-slate-800 border border-slate-700 rounded-lg p-2 px-3 text-xs flex justify-between">
                                        <span className="text-white">4. Extra Kissen</span><span className="text-m-brand-gold">+2 Stück Ecru</span>
                                    </div>
                                </div>
                                <div className="absolute bottom-0 left-0 right-0 h-12 bg-gradient-to-t from-black/60 to-transparent"></div>
                            </div>
    ...
    <section id="slide-4" className="slide">
        <div className="max-w-6xl mx-auto w-full fade-in text-center mb-16">
            <span className="text-m-brand-gold font-bold tracking-[0.2em] uppercase text-sm mb-4 block">Die Lösung liegt bei uns</span>
            <h2 className="font-serif text-4xl md:text-6xl text-white mb-6">Ihr Eigentum: Unsere individuelle E-Commerce-Infrastruktur</h2>
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">Wir vermieten keine Abonnements; wir verkaufen provisionsfreies, schlüsselfertiges 'Eigentum'.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto fade-in delay-1">
            <div className="glass-card p-6 flex flex-col items-center text-center rounded-2xl">
                ...
                <h4 className="font-bold text-white mb-2">Abmahnschutz</h4>
                <p className="text-slate-400 text-sm">100% konform mit österreichischen Gesetzen (DSGVO, Warenkorb-Bestätigung).</p>
            </div>
            ...
            <div className="glass-card p-6 flex flex-col items-center text-center rounded-2xl">
                ...
                <h4 className="font-bold text-white mb-2">Native Mehrsprachigkeit</h4>
                <p className="text-slate-400 text-sm">Deutsch, Englisch und Türkisch sind standardmäßig integriert. Verkaufen Sie Möbel und sprechen Sie sofort multinationale Kunden an.</p>
            </div>
            ...
            <div className="glass-card p-6 flex flex-col items-center text-center rounded-2xl">
                ...
                <h4 className="font-bold text-white mb-2">100% Ihre Daten</h4>
                <p className="text-slate-400 text-sm">Ihre Kundenliste, Umsätze und Bestellanalysen liegen nicht auf riesigen SaaS-Servern, sondern auf einem geschlossenen Server nur für Sie.</p>
            </div>
            ...
            <div className="glass-card p-6 flex flex-col items-center text-center rounded-2xl">
                ...
                <h4 className="font-bold text-white mb-2">Kein doppelten Provisionen</h4>
                <p className="text-slate-400 text-sm">Keine zusätzlichen Umsatzbeteiligungen an Plattformen wie Shopify. Nur die regulären Zahlungsprovider-Gebühren fallen an.</p>
            </div>
        </div>
    </section>
        ...
        <div className="max-w-6xl mx-auto w-full fade-in grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1 relative rounded-[2rem] overflow-hidden shadow-2xl border border-slate-700 bg-[#111827]">
                ...
                <div className="p-6 h-[400px] flex flex-col gap-4 relative">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-slate-800 border border-slate-700 p-4 rounded-xl">
                            <span className="text-xs text-slate-400 block mb-1">Monatlicher Umsatz</span>
                            <span className="text-2xl text-emerald-400 font-bold">€34.250,<sup>00</sup></span>
                        </div>
                        <div className="bg-slate-800 border border-slate-700 p-4 rounded-xl">
                            <span className="text-xs text-slate-400 block mb-1">Offene Bestellungen</span>
                            <span className="text-2xl text-white font-bold">12</span>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 bg-slate-800 border-2 border-red-500/20 rounded-xl p-4 flex flex-col justify-center relative overflow-hidden group">
                        ...
                        <div className="flex items-center gap-4 mb-4">
                            <span className="material-symbols-outlined text-red-500 text-3xl animate-pulse">local_shipping</span>
                            <div>
                                <h4 className="text-white font-bold">Logistik Versandverzögerung Warnung</h4>
                                <p className="text-xs text-red-300">Bestellung ORD-9921 - Warnung 'Versandt' fehlt.</p>
                            </div>
                        </div>
                        <p className="text-slate-400 text-sm">Das System verfolgt Produkte, deren Zahlung abgeschlossen ist, die aber nach 24-48 Stunden nicht versandt wurden, und gibt Alarm. Sie greifen ein, bevor der Kunde wütend wird.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="order-1 lg:order-2">
                ...
                <ul className="space-y-6">
                    <li className="flex items-start gap-4">
                        <span className="material-symbols-outlined text-m-brand-gold mt-1 text-3xl">view_carousel</span>
                        <div>
                            <h4 className="font-bold text-white text-xl">Dynamisches Startseiten-Management</h4>
                            <p className="text-sm text-slate-400 mt-1">Sommerkampagne? Ändern Sie Banner und Produktblöcke auf Ihrer Startseite in Sekunden über das Dashboard. Kein zusätzliches Budget für Softwareagenturen erforderlich.</p>
                        </div>
                    </li>
                    <li className="flex items-start gap-4">
                        <span className="material-symbols-outlined text-m-brand-gold mt-1 text-3xl">timer</span>
                        <div>
                            <h4 className="font-bold text-white text-xl">Warenkorb-Reservierungs-Intelligenz</h4>
                            <p className="text-sm text-slate-400 mt-1">Unser System blockiert den Bestand für 15 Minuten für den Kunden, der es in den Warenkorb legt. Kein Umsatzverlust durch 'Produkt ausverkauft'-Fehler.</p>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <section id="slide-6" className="slide bg-slate-900 border-t border-slate-800">
        <div className="max-w-6xl mx-auto w-full fade-in">
            <div className="text-center mb-16">
                <h2 className="font-serif text-4xl md:text-6xl gold-gradient-text mb-4">Langfristige Investitionsanalyse</h2>
                <p className="text-slate-400 text-lg max-w-2xl mx-auto">Eine finanzielle Prognose zwischen abonnementbasierten Fertig-Systemen und unserem Eigentumsmodell.</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-stretch max-w-5xl mx-auto">
                ...
                <div className="relative glass-card rounded-[2rem] p-8 md:p-12 pb-16 border-slate-700">
                    <div className="flex items-center gap-4 mb-8">
                        <span className="material-symbols-outlined text-red-400 text-4xl">warning</span>
                        <h3 className="text-3xl font-bold text-slate-300">Abonnementmodell (z.B. Shopify)</h3>
                    </div>
                    
                    <ul className="space-y-4 text-slate-400 mb-8 pb-8 border-b border-slate-700 font-medium">
                        <li className="flex items-center gap-3"><span className="text-red-400 font-bold shrink-0">✕</span> Design- und Theme-Einrichtungsgebühr (Agentur)</li>
                        <li className="flex items-center gap-3"><span className="text-red-400 font-bold shrink-0">✕</span> Plattform-Abonnement (Grow): 105€ / Monat</li>
                        <li className="flex items-center gap-3"><span className="text-red-400 font-bold shrink-0">✕</span> Erforderliche österreichische (Legal) Apps: ~60€ / Monat</li>
                        <li className="flex items-center gap-3"><span className="text-red-400 font-bold shrink-0">✕</span> 100+ Zusätzliche Varianten-App: ~40€ / Monat</li>
                        <li className="flex items-center gap-3"><span className="text-red-400 font-bold shrink-0">✕</span> 2% Plattform-Verkaufsprovision zusätzlich zu Zahlungsgebühren</li>
                    </ul>
                    <div className="text-center">
                        <p className="text-sm text-slate-500 uppercase tracking-widest mb-2 font-bold">Langfristige geschätzte Ausgaben</p>
                        <p className="text-4xl font-black text-red-400 mb-1">Hohe Fixkosten</p>
                        <p className="text-xs text-slate-500 mt-2">Wenn das System geschlossen wird, behalten Sie die Infrastruktur nicht.</p>
                    </div>
                </div>

                {/*  Custom  */}
                <div className="relative bg-gradient-to-br from-m-brand-900 to-slate-900 rounded-[2rem] p-8 md:p-12 pb-16 border-2 border-m-brand-gold shadow-[0_0_50px_rgba(180,151,90,0.15)] transform md:-translate-y-6 z-10">
                    <div className="absolute -top-5 right-8 bg-m-brand-gold text-m-brand-900 px-6 py-2 rounded-full text-xs font-black border border-m-brand-goldlight shadow-lg">INTELLIGENTER HANDEL</div>
                    <div className="flex items-center gap-4 mb-8">
                        <span className="material-symbols-outlined text-m-brand-gold text-4xl">workspace_premium</span>
                        <h3 className="text-3xl font-bold text-white">Unsere Lösung (Eigentum)</h3>
                    </div>
                    
                    <ul className="space-y-4 text-slate-300 mb-8 pb-8 border-b border-slate-700 font-medium">
                        <li className="flex items-center gap-3"><span className="text-emerald-400 font-bold shrink-0">✓</span> Einmaliger 'Schlüsselfertiger' Shop-Aufbau</li>
                        <li className="flex items-center gap-3"><span className="text-emerald-400 font-bold shrink-0">✓</span> Keine Plattformprovision (Nur Provider-Gebühren)</li>
                        <li className="flex items-center gap-3"><span className="text-emerald-400 font-bold shrink-0">✓</span> Erweiterte Möbelvarianten direkt eingebaut (Unbegrenzt)</li>
                        <li className="flex items-center gap-3"><span className="text-emerald-400 font-bold shrink-0">✓</span> Code und Daten auf Ihrem Server gehören 100% Ihnen</li>
                        <li className="flex items-center gap-3"><span className="text-emerald-400 font-bold shrink-0 opacity-70 border-b border-emerald-500/30 border-dashed">Nur geringe Server-/Wartungskosten. (Keine Apps)</span></li>
                    </ul>
                    <div className="text-center">
                        <p className="text-sm text-m-brand-gold uppercase tracking-widest mb-2 font-bold">Gewinn-/Verlust-Synergie</p>
                        <p className="text-4xl font-black text-white">Investition amortisiert sich</p>
                        <p className="text-xs text-m-brand-gold mt-2">Von der ersten Zeile an profitieren Sie vom Kaufen statt Mieten.</p>
                    </div>
                </div>
            </div>
